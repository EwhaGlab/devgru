...
class ImageRNN(BaseModel):
    def __init__(
        ...
        """
        super(ImageRNN, self).__init__(context_size, len_traj_pred, learn_angle)
        ...
        self.image_rnn = GRUModel(  input_size  = self.obs_encoding_size,
    ...
    def forward(
        self, obs_images: torch.tensor, goal_image: torch.tensor,
        ...
        # gru model
        final_repr = self.image_rnn( tokens )       # [B, 32]
