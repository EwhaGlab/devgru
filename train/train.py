...
from vint_train.models.vint_rgbd.vint_rgbd import ViNT_RGBD
from vint_train.models.vint_rgbd.vit import ViT
...
def main(config):
    ...
    elif config["model_type"] == "vint-rgbd":
        model = ViNT_RGBD(
            context_size=config["context_size"],
            len_traj_pred=config["len_traj_pred"],
            learn_angle=config["learn_angle"],
    ...
    if config["model_type"] == "vint" or config["model_type"] == "vint-rgbd" or config["model_type"] == "gnm":
        train_eval_loop(
